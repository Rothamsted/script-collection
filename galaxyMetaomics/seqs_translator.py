...
def Seqs_Translator(proper_id, have_seqs, trans_fr, gen_code,gl_tr_file1,gl_tr_file2,gl_tr_file3,gl_tr_file4,gl_tr_file5,gl_tr_file6):
	...
	global  out1,out2,out3,out4,out5,out6,gl_fw_file7, gl_rc_file8, gl_l0_file9, \
	...
	if trans_fr == 6:
		...
		#############################
		## 1
		'''out1.write(">" + proper_id + "_fr1" + " translation_frame:1" + \
					" STOP:" + `stop_count1` + " ANY(X):" + `any_count1` + \
					" LONGEST:" + `longest_fr1` + " TOTAL_LENGTH:" + `total_size1` + \
					" " + full_frame1 + ":" + `frm_number1` + '\n')
		out1.write(my_string1 + '\n')
		## 2
		out2.write(">" + proper_id + "_fr2" + " translation_frame:2" + \
					" STOP:" + `stop_count2` + " ANY(X):" + `any_count2` + \
					" LONGEST:" + `longest_fr2` + " TOTAL_LENGTH:" + `total_size2` + \
					" " + full_frame2 + ":" + `frm_number2` + '\n')
		out2.write(my_string2 + '\n')
		## 3
		out3.write(">" + proper_id + "_fr3" + " translation_frame:3" + \
					" STOP:" + `stop_count3` + " ANY(X):" + `any_count3` + \
					" LONGEST:" + `longest_fr3` + " TOTAL_LENGTH:" + `total_size3` + \
					" " + full_frame3 + ":" + `frm_number3` + '\n')
		out3.write(my_string3 + '\n')
		## 4
		out4.write(">" + proper_id + "_fr4" + " translation_frame:4" + \
		...
		## 5
		out5.write(">" + proper_id + "_fr5" + " translation_frame:5" + \
		...
		## 6
		out6.write(">" + proper_id + "_fr6" + " translation_frame:6" + \
		...
		out1.write(my_string1 + '\n')
		## 2
		out2.write(">" + proper_id  + '\n')
		out2.write(my_string2 + '\n')
		## 3
		out3.write(">" + proper_id  + '\n')
		out3.write(my_string3 + '\n')
		## 4
		out4.write(">" + proper_id  + '\n')
		out4.write(my_string4 + '\n')
		## 5
		out5.write(">" + proper_id  + '\n')
		out5.write(my_string5 + '\n')
		## 6
		out6.write(">" + proper_id + '\n')
		out6.write(my_string6 + '\n')
		#############################
		## LONGEST ##
		llen1 = len(longest_orf1)
...
def Seqs_Cleaner(in_name, out_name, seq_type, trans_fr, gen_code, bin_mode, seqs_min_len,gl_tr_file1,gl_tr_file2,gl_tr_file3,gl_tr_file4,gl_tr_file5,gl_tr_file6):
		...
		if trans_fr != 0:
			...
			if trans_fr == 3:
				...
				gl_ls_file9.write("SEQ_ID" + '\t' + \
					...
					"LONGEST" + '\t' + "FRAME" + '\t' + "DUPL" + '\n')
			if trans_fr == 6:
				#gl_tr_file1 = open(out_name + '.tr_frame1.fasta', "wb")
				out1 = open(gl_tr_file1, 'wb' ) 
				out2 = open(gl_tr_file2, 'wb' ) 
				out3 = open(gl_tr_file3, 'wb' ) 
				out4 = open(gl_tr_file4, 'wb' ) 
				out5 = open(gl_tr_file5, 'wb' ) 
				out6 = open(gl_tr_file6, 'wb' ) 
				
				'''gl_tr_file2 = open(out_name + '.tr_frame2.fasta', "wb")
				gl_tr_file3 = open(out_name + '.tr_frame3.fasta', "wb")
				gl_tr_file4 = open(out_name + '.tr_frame4.fasta', "wb")
				gl_tr_file5 = open(out_name + '.tr_frame5.fasta', "wb")
				gl_tr_file6 = open(out_name + '.tr_frame6.fasta', "wb")
				gl_fw_file7 = open(out_name + '.forwrd', "wb")
				gl_rc_file8 = open(out_name + '.revcom', "wb")
				gl_l0_file9 = open(out_name + '.x0_log', "wb")
				gl_l1_file9 = open(out_name + '.x1_log', "wb")
		...
		if t == '':
			...
			if seqs_len != 0:
				...
				if trans_fr == 1 and seqs_len >= seqs_min_len:
					...
					Seqs_Translator(proper_id, have_seqs, trans_fr, gen_code,gl_tr_file1,gl_tr_file2,gl_tr_file3,gl_tr_file4,gl_tr_file5,gl_tr_file6)
...
if __name__ == "__main__":
	...
	if len(sys.argv) <= 13 or len(sys.argv) > 14:
		print ""
		print "  Program usage: "
		print "  input_file  output_file  DNA/prot  trans_frame[0 1 3 6]  genetic_code[1 2 3]  BIN/NOBIN  seqs_min_len"
	...
	if len(sys.argv) == 14:
		...
		if bin_mode != "BIN" and bin_mode != "NOBIN":
			...
			sys.exit()
		if in_name != out_name:
			Seqs_Cleaner(in_name, out_name, seq_type, trans_fr, gen_code, bin_mode, seqs_min_len, f1, f2, f3, f4, f5, f6)
		else:
